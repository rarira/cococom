...
const Input = React.forwardRef(
  (
    { className, variant = 'outline', size = 'md', ...props }: { className?: string } & IInputProps,
    ref?: any,
  ) => {
    return (
      <UIInput
...
const InputSlot = React.forwardRef(
  ({ className, ...props }: { className?: string } & IInputSlotProps, ref?: any) => {
    return (
      <UIInput.Slot
        ref={ref}
        {...props}
...
const InputField = React.forwardRef(
  ({ className, ...props }: { className?: string } & IInputFieldProps, ref?: any) => {
