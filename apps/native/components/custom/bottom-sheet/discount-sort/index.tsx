...
interface DiscountSortBottomSheetProps {
  currentSort: keyof typeof DISCOUNT_SORT_OPTIONS;
  onSortChange: (sort: keyof typeof DISCOUNT_SORT_OPTIONS) => void;
}

const DiscountSortBottomSheet = memo(
  forwardRef<BottomSheetModal, DiscountSortBottomSheetProps>(function DiscountSortBottomSheet(
    { currentSort, onSortChange }: DiscountSortBottomSheetProps,
    ref,
  ) {
...
export default DiscountSortBottomSheet;
