...
import { RANKING_SORT_OPTIONS } from '@/libs/sort';

interface RankingSortBottomSheetProps {
  currentSort: keyof typeof RANKING_SORT_OPTIONS;
  onSortChange: (sort: keyof typeof RANKING_SORT_OPTIONS) => void;
}

const RankingSortBottomSheet = memo(
  forwardRef<BottomSheetModal, RankingSortBottomSheetProps>(function RankingSortBottomSheet(
    { currentSort, onSortChange }: RankingSortBottomSheetProps,
    ref,
  ) {
    ...
    const sortOptions = useMemo(
      () =>
        Object.entries(RANKING_SORT_OPTIONS).map(([key, sortOption]) => (
          <Button
            key={key}
...
export default RankingSortBottomSheet;
